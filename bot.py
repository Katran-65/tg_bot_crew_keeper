...
RESPONSES = {
    "манчестер": ["Манчестер синий", "Если щас опять начнется противостояние МЮ, Челси и Ливерпуля, я уйду спать!",
                  "Надоели", "ЗА КРАСНЫХ ДЬЯВОЛОВ!!!!"],
    "мю": ["МЮ - молодость и юность. Это многое объясняет...", "Если щас опять начнется противостояние МЮ, Челси и Ливерпуля, я уйду спать!",
                  "Надоели", "ЗА КРАСНЫХ ДЬЯВОЛОВ!!!!"],
    "челси": ["Опять о своём футболе базарят", "скуууушноооо", "девочки, не ссорьтесь! футболт это мир!"],
    "ливер": ["Ливерпуль кстати кравсный. Как и еще одна команда...", "А Миша в итоге за ливер или за челси?", "Ребята, давайте жить дружно!"],
    "душн": ["Откройте форточку", "Зануда)", "кубок зануд уже твой, забей", "Между прочим носки тут только у одной душнилы!"],
    ...
    "tonny petrony": ["Сборище клеопатр вызывает Антонио.", "Занят. Работает. Делает свой стартап.", "Он в этом чате единственный мужик, дайте человеку отдохнуть уже.."]
}
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Если нашли совпадения, отправляем случайный ответ с вероятностью 55%
    if triggered_responses and random.random() < 0.55:
